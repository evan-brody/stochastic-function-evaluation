...
def asum_greater_bsum(x): return x[0] + x[1] - x[2] - x[3]
def asum_greater_csum(x): return x[0] + x[1] - x[4] - x[5]
...
constraints = [
    ...
    {'type': 'ineq', 'fun': abeta_greater_bbeta},
    {'type': 'ineq', 'fun': abeta_greater_cbeta},

    {'type': 'ineq', 'fun': agamma_greater_bgamma},
    {'type': 'ineq', 'fun': agamma_greater_cgamma},

    {'type': 'ineq', 'fun': bbeta_greater_cbeta},
    {'type': 'ineq', 'fun': cgamma_greater_bgamma}
]
